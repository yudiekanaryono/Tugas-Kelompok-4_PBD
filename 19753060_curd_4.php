...
function read_data() {
	...
	<table border=1 cellpadding=2>
		<tr>
			<td colspan="5"><a href="19753060_curd_4.php?a=input">INPUT</a></td>
		</tr>
		<tr>
			<td>ID</td>
			<td>KODE</td>
		...
		<tr>
			...
			<td>
				<a href="19753060_curd_4.php?a=edit&id=<?php echo $row ['idprodi']; ?>">EDIT</a>
				<a href="19753060_curd_4.php?a=hapus&id=<?php echo $row ['idprodi']; ?>">HAPUS</a>
			</td>
		</tr>
		<?php } ?>
	</table>
...
function input_data() {
	...
	<form action="19753060_curd_4.php?a=list" method="post">
		...
		<input type="radio" name="akreditasi" value="C" <?php if ($row["akreditasi"]=='C') {echo "checked=\"checked\""; } else {echo "";} ?> > C
			...
			<br>
			<a href="19753060_curd_4.php?a=list">Batal</a>
	</form>
<?php } ?>
